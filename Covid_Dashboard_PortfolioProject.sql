...
--looking are countries with highest infection rate compared to population with DATE

Select location, Population, date, max(total_cases) as Highest_Infection_Count, MAX((total_cases/population))*100 as Contact_Percentage
from Portfolio_Project..Covid_Deaths
--where location like '%India%'
